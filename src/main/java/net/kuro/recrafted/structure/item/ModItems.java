...
public class ModItems {
    ...
    public static final Item COPPER_AXE = registerItem("copper_axe",
            new AxeItem(ModToolMaterials.COPPER, 6.0f, -3.2f, new FabricItemSettings()));
    public static final Item COPPER_SHOVEL = registerItem("copper_shovel",
            new ShovelItem(ModToolMaterials.COPPER, 1.5f, -3.0f, new FabricItemSettings()));
    public static final Item COPPER_HOE = registerItem("copper_hoe",
            new HoeItem(ModToolMaterials.COPPER, 0, -3.0f, new FabricItemSettings()));
    ...
    public static final Item COPPER_HAMMER = registerItem("copper_hammer",
            new SwordItem(ModToolMaterials.COPPER, 4, -2.8f, new FabricItemSettings()));

    public static final Item BRONZE_HAMMER = registerItem("bronze_hammer",
            new SwordItem(ModToolMaterials.BRONZE, 4, -2.8f, new FabricItemSettings()));
    public static final Item BISMUTH_BRONZE_HAMMER = registerItem("bismuth_bronze_hammer",
            new SwordItem(ModToolMaterials.BISMUTH_BRONZE, 4, -2.8f, new FabricItemSettings()));
    public static final Item BLACK_BRONZE_HAMMER = registerItem("black_bronze_hammer",
            new SwordItem(ModToolMaterials.BLACK_BRONZE, 4, -2.8f, new FabricItemSettings()));
    public static final Item WHITE_BRONZE_HAMMER = registerItem("white_bronze_hammer",
            new SwordItem(ModToolMaterials.WHITE_BRONZE, 4, -2.8f, new FabricItemSettings()));
    public static final Item IRON_HAMMER = registerItem("iron_hammer",
            new SwordItem(ModToolMaterials.IRON, 4, -2.8f, new FabricItemSettings()));
    public static final Item STEEL_HAMMER = registerItem("steel_hammer",
            new SwordItem(ModToolMaterials.STEEL, 4, -2.8f, new FabricItemSettings()));
